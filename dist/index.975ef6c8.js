...
var _annonceItemJs = require("./elements/annonce-item.js");
var _categorieItemJs = require("./elements/categorie-item.js");
var _annoncesJs = require("./sections/annonces.js");
var _categoriesJs = require("./sections/categories.js");
...
const routeur = ()=>{
    ...
    switch(hashs[0]){
        case "#latest":
            (0, _helpersJs.displaySection)("annonces");
            (0, _annoncesJs.displayAds)();
            break;
        case "#annonces":
            (0, _helpersJs.displaySection)("annonce-details");
            (0, _annoncesJs.displayUneAnnonce)(hashs[1]);
            break;
        case "#categories":
            if (hashs[1]) {
                (0, _helpersJs.displaySection)("annonces");
                (0, _annoncesJs.displayAdsCategorie)(hashs[1]);
            } else {
                (0, _helpersJs.displaySection)("categories");
                (0, _categoriesJs.displayCategories)();
            }
            break;
        case "#starred":
            (0, _helpersJs.displaySection)("annonces");
            (0, _annoncesJs.displayFavoriteAds)();
            break;
        case "#account":
            (0, _helpersJs.displaySection)("account");
            break;
    }
};
...
},{"./elements/annonce-item.js":"g4iTn","./elements/categorie-item.js":"h0c9s","./sections/annonces.js":"hmPsh","./sections/categories.js":"ik6tC","./helpers.js":"ecN5O"}],"g4iTn":[function(require,module,exports) {
...
},{}],"h0c9s":[function(require,module,exports) {
class CategorieItem extends HTMLElement {
    ...
    render() {
        this.innerHTML = `<a href=${this.getAttribute("href")}>
            ...
            <div class="categories__box__count">${this.getAttribute("count")} \xe9l\xe9ments</div>
        </a>`;
    }
}
customElements.define("categorie-item", CategorieItem);

},{}],"hmPsh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayAds", ()=>displayAds);
parcelHelpers.export(exports, "displayAdsCategorie", ()=>displayAdsCategorie);
parcelHelpers.export(exports, "displayUneAnnonce", ()=>displayUneAnnonce);
parcelHelpers.export(exports, "displayFavoriteAds", ()=>displayFavoriteAds);
...
function displayAdsArray(ads) {
    ...
    ads.forEach((ad)=>{
        ...
        adElement.setAttribute("star", !!(0, _localStorage.getItem)(ad.id));
        ...
        adElement.addEventListener("star_click", ()=>{
            if ((0, _localStorage.getItem)(ad.id)) (0, _localStorage.removeItem)(ad.id);
            else (0, _localStorage.setItem)(ad.id, ad);
            adElement.setAttribute("star", !!(0, _localStorage.getItem)(ad.id));
        });
...
function displayAds() {
    (0, _api.loadAnnonces)().then((ads)=>{
        listSectionTitle.innerHTML = `Derni\xe8res annonces (${ads.length})`;
        displayAdsArray(ads);
    });
}
function displayAdsCategorie(id) {
    (0, _api.loadAdsCategorie)(id).then((ads)=>{
        console.log(ads);
        listSectionTitle.innerHTML = `Cat\xe9gories > ${ads[0].category.name} (${ads[0].category.count})`;
        displayAdsArray(ads);
    });
}
function displayUneAnnonce(id) {
    (0, _api.loadAnnonce)(id).then((ad)=>{
...
function displayFavoriteAds() {
    const allAds = (0, _localStorage.getItems)();
    listSectionTitle.innerHTML = `Int\xe9ressantes (${allAds.length})`;
    displayAdsArray(allAds);
}

},{"../api":"8Zgej","../lib/local-storage":"31enr","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8Zgej":[function(require,module,exports) {
// URL de base du serveur
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadAnnonces", ()=>loadAnnonces);
parcelHelpers.export(exports, "loadCategories", ()=>loadCategories);
parcelHelpers.export(exports, "loadAdsCategorie", ()=>loadAdsCategorie);
parcelHelpers.export(exports, "loadAnnonce", ()=>loadAnnonce);
...
},{}],"31enr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ik6tC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayCategories", ()=>displayCategories);
var _api = require("../api");
const categorieList = document.querySelector(".categories");
function displayCategories() {
    (0, _api.loadCategories)().then((categories)=>{
...
},{"../api":"8Zgej","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ecN5O":[function(require,module,exports) {
